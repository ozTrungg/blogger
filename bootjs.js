...
var $window = $(window);
var div_position = 0;
var $register_push = undefined;
$window.scroll(function () {
    div_position = $("#st-postleft").offset().top;
    if (($window.scrollTop() >= div_position + 1350)) {
        if ($("#st-postleft").height() - $("#HTML10").height() >= ($window.scrollTop() - div_position + 35)) {
            $("#HTML10").css({
                position: "fixed",
                top: 65,
                width: $("#HTML10").parent().width(),
                "margin-top": "auto"
            })
        } else {
            $("#HTML10").css({
                position: "inherit",
                top: $("#st-postleft").height() - $("#HTML10").height(),
                "margin-top": $("#st-postleft").height() - $("#HTML10").height() - 900
            })
        }
    } else {
        $("#HTML10").css({
...
window.onload = function () {
    $register_push = RegisterPush.subscribe()
};
